        ...
        if (turnContext.activity.membersAdded.length !== 0) {
            ...
            for (var idx in turnContext.activity.membersAdded) {
                ...
                if (turnContext.activity.membersAdded[idx].id !== turnContext.activity.recipient.id) {
                    // Welcome user.
                    const msg = "**Hi, ich bin der Loop-Bot**\nIch kann dir beim Üben für den Online-Kurs \"Lernen objekt-orientierter Programmierung\" helfen!\n![GreetingGif](" + GifGreeting() + ")";
                    ...
                    await turnContext.sendActivity(MessageFactory.attachment(CardFactory.heroCard("", msg)));
                    // Send welcome card.
