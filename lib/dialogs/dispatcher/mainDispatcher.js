...
class MainDispatcher extends ComponentDialog {
    ...
    constructor(onTurnAccessor, conversationState, userState) {
        ...
        this.addDialog(new Chapter1(this.onTurnAccessor, this.conversationState))
    ...
    async beginChildDialog(dc, onTurnProperty) {
        ...
        switch (onTurnProperty.intent) {
            ...
            default:
                return await dc.context.sendActivity(`Ich bin auch selber noch am üben... Es tut mir leid ich weiß nicht was du meinst.`);
