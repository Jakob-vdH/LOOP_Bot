...
class UserProfile {
     ...
     * @param {String} currentChapter current chapter that is worked on
     */
    constructor(userId, currentChapter, chapter1, chapter2, chapter3, chapter4, chapter5) {
        ...
        this.currentChapter = currentChapter ? currentChapter : "chapter1";
    }
    ...
    async updateInDb() {
        ...
        await manager.updateExistingUser({ userId: this.userId, currentChapter: this.currentChapter, chapter1: this.chapter1, chapter2: this.chapter2, chapter3: this.chapter3, chapter4: this.chapter4, chapter5: this.chapter5 });
    }
}
